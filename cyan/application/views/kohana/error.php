...
#kohana_error div.content { overflow: hidden; }
...
<!-- Modal -->
<div id="modal_error" class="modal modal-error" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
		<h3 id="myModalLabel"><?php echo $class ?> [ <?php echo $code ?> ]: <?php echo HTML::chars($message) ?></h3>
	</div>
	...
	<div class="modal-footer">
		<button class="btn" data-dismiss="modal" aria-hidden="true"><?php echo __("Dang!"); ?></button>
	</div>
</div>
