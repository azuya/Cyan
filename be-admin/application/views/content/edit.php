...
<div id="content-edit-<?php echo $content->id; ?>" class="screen active">
	...
	<div class="be-main">
		...
		<?php isset($content->type_id) ? $content->type_id : $content->type_id = Arr::get($_GET, 'content-type', '0'); ?>
		<?php echo Form::open('content/post/'.$content->id, array("class" => "form-horizontal")); ?>
