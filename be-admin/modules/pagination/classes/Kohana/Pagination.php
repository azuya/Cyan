...
class Kohana_Pagination {
	...
	public function __construct(array $config = array(), Request $request = NULL)
	{
		...
		// AD:
		$this->_route_params['directory'] = strtolower($request->directory());
		$this->_route_params['controller'] = strtolower($request->controller());
		$this->_route_params['action'] = strtolower($request->action());
		// ----
